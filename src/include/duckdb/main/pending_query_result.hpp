...
public:
    ...
    DUCKDB_API PendingExecutionResult ExecuteTaskRatchet(const string &ratchet_file);
...
private:
    ...
    PendingExecutionResult ExecuteTaskInternalRatchet(ClientContextLock &lock, const string &ratchet_file);
