...
Ratchet is a prototype system for efficiently query suspend and resume for push-based query execution.

Ratchet is based on DuckDB v0.7.1

~~Ratchet is based on DuckDB v0.6.1~~
