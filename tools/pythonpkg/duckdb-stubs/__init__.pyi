...
class DuckDBPyConnection:
    ...
    def execute_resume(self, query: str, resume_location: str, partition_resume: bool, parameters: object = ..., multiple_parameter_sets: bool = ...) -> DuckDBPyConnection: ...
    def execute_suspend(self, query: str, suspend_location: str, suspend_start_time: float, suspend_end_time: float, partition_suspend: bool, parameters: object = ..., multiple_parameter_sets: bool = ...) -> DuckDBPyConnection: ...
